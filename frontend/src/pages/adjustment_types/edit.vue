                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Edit Adjustment Types</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName: {
				type: String,
				default: 'adjustment_typesedit',
			},
			pagePath: {
				type : String,
				default : 'adjustment_types/edit',
			},
			apiPath: {
				type: String,
				default: 'adjustment_types/edit',
		...
		methods: {
			...mapActions('adjustment_types', ['updateRecord', 'fetchRecord']),
				...
				if(isFormValid){
					...
					this.updateRecord(data).then(
						(response) => {
							...
							if(this.redirect) this.navigateTo(`/adjustment_types`);
						},
						(response) => {
							this.saving = false;
