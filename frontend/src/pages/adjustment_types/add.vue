                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Add New Adjustment Types</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props:{
			...
			routeName : {
				type : String,
				default : 'adjustment_typesadd',
			},
			apiPath : {
				type : String,
				default : 'adjustment_types/add',
			},
		},
		data() {
            return {
		...
		computed: {
			pageTitle:{
				get: function () {
					return "Add New Adjustment Types"
				}
			},
		},
		meta () {
		...
		methods: {
			...mapActions('adjustment_types', ['saveRecord']),
