                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Edit Departments</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 col-12">
                                                                <ValidationProvider :rules="{required:true}" name="Department" v-slot="{ errors, invalid, validated }">
                                                                    <q-input outlined dense  ref="ctrldepartment" v-model.trim="formData.department"  label="Department" type="text" placeholder="Enter Department"      
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName: {
				type: String,
				default: 'departmentsedit',
			},
			pagePath: {
				type : String,
				default : 'departments/edit',
			},
			apiPath: {
				type: String,
				default: 'departments/edit',
		...
		methods: {
			...mapActions('departments', ['updateRecord', 'fetchRecord']),
				...
				if(isFormValid){
					...
					this.updateRecord(data).then(
						(response) => {
							...
							if(this.redirect) this.navigateTo(`/departments`);
						},
						(response) => {
							this.saving = false;
