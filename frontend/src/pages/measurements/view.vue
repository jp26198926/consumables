                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Measurements Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/measurements/edit/${item.id}`">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'measurementsview',
			},
			pagePath: {
				type : String,
				default : 'measurements/view',
			},
			apiPath: {
				type : String,
				default : 'measurements/view',
		...
		methods: {
			...mapActions("measurements", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
