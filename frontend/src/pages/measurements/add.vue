                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Add New Measurements</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <ValidationProvider :rules="{required:true}" name="Code" v-slot="{ errors, invalid, validated }">
                                                        <q-input outlined dense  ref="ctrlcode" v-model.trim="formData.code"  label="Code" type="text" placeholder="Enter Code"      
...
<script>
	...
	export default {
		...
		props:{
			...
			routeName : {
				type : String,
				default : 'measurementsadd',
			},
			apiPath : {
				type : String,
				default : 'measurements/add',
			},
		},
		data() {
            return {
		...
		methods: {
			...mapActions('measurements', ['saveRecord']),
			async startSaveRecord(){
				...
				if(isFormValid){
					...
					this.saveRecord(data).then((response) => {
						...
						if(this.redirect) this.navigateTo(`/measurements`);
					},
					 (response) => {
						this.saving = false;
