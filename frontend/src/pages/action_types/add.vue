                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Add New Action Types</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props:{
			...
			routeName : {
				type : String,
				default : 'action_typesadd',
			},
			apiPath : {
				type : String,
				default : 'action_types/add',
			},
		},
		data() {
            return {
		...
		methods: {
			...mapActions('action_types', ['saveRecord']),
