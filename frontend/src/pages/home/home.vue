            ...
            <div class="container-fluid">
                <div class="row q-col-gutter-x-md">
                    <div class="col-sm-12 col-md-3 comp-grid" >
                        <record-count api-path="components_data/action_type_option_list_2" max="" v-slot="record">
                    ...
                    <div class="col-sm-12 col-md-3 comp-grid" >
                        <record-count api-path="components_data/action_type_option_list_3" max="" v-slot="record">
                    ...
                    <div class="col-sm-12 col-md-3 comp-grid" >
                        <record-count api-path="components_data/action_type_option_list_4" max="" v-slot="record">
                    ...
                    <div class="col-sm-12 col-md-3 comp-grid" >
                        <record-count api-path="components_data/action_type_option_list_5" max="" v-slot="record">
