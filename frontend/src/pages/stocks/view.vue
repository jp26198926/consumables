                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Stocks Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.item_id }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>Action Id: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.action_id }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/stocks/edit/${item.id}`">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions("stocks", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
