                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Dv Updated Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'dv_updatedview',
			},
			pagePath: {
				type : String,
				default : 'dv_updated/view',
			},
			apiPath: {
				type : String,
				default : 'dv_updated/view',
		...
		methods: {
			...mapActions("dv_updated", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
