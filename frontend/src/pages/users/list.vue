                ...
                <div class="container-fluid">
                    <div class="row justify-between q-col-gutter-md">
                        ...
                        <div class="col-md-auto col-12 " >
                            <template v-if="$can.view('/users/add')">
                                            ...
                                            <template >
                                                ...
                                                <template v-slot:body="props">
                                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-td  key="telelphone" :props="props">
                                                            <q-btn padding="xs"   flat :rounded="false"  size=""  color="primary"  no-caps  unelevated   type="a" :href="'tel:' + props.row.telelphone">{{ props.row.telelphone }}</q-btn>
                                                        </q-td>
                                                        ...
                                                        <q-td  key="user_role_id" :props="props">
                                                            <q-btn v-if="props.row.user_role_id" @click="openPageDialog({ page: 'roles/view', url: `/roles/view/${props.row.user_role_id}` }, { closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                                ...
                                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                        <q-list dense rounded nav>
                                                                            <template v-if="$can.view('users/view')">
