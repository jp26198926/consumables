...
<script>
	...
	export default {
		...
		data() {
            return {
				formData: {
					name: "", username: "", email: "", password: "", confirm_password: "", telelphone: "", photo: "", user_role_id: "", 
				},
			}
		},
		computed: {
		...
		methods: {
			...
			resetForm (){
				this.formData = {name: "", username: "", email: "", password: "", confirm_password: "", telelphone: "", photo: "", user_role_id: "", };
