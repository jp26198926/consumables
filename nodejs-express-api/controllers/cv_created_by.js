/** Express router providing Cv_Created_By related routes
 * @module routers/Cv_Created_By
 * @requires express
...
/**
 * Cv_Created_By models
 * @const
 */
const models = require('../models/index.js');
const Cv_Created_By = models.Cv_Created_By;
